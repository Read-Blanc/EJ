...
export default function CreateEditQuestion() {
  ...
  useEffect(() => {
    ...
    supabase
      .from("questions")
      .select("text, marks, answer_length, sample_answer, assessment_id")
      .eq("id", id)
      .single()
      .then(({ data }) => {
        if (data)
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 bg-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 transition resize-none"
            />
          </div>
